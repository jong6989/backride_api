    ...
    */
    ...
    public function showRestaurants()
    {
        ...
        if ($this->request->isPost()) {
            ...
            $restaurants = $this->Restaurant->getNearByRestaurants($lat, $long, $user_id);
            $promoted_restaurants = $this->Restaurant->getPromotedRestaurants($lat, $long, $user_id);
            $output['code'] = 200;
    ...
    public function showRestaurantsMenutest()
    {
        ...
        if ($this->request->isPost()) {
           ...
           if(count($restaurant_timing) > 0) {
                ...
                if (strtotime($time) >= strtotime($opening_time) && strtotime($time) <= strtotime($closing_time)) {
