 ...
 */
    ...
    public function deleteMainMenu()
    {
        ...
        if ($this->request->isPost()) {
            ...
            $menu_item_details = $this->RestaurantMenu->getDetails($menu_id);

            $code = 201;
            $message = "error";
            if(count($menu_item_details) > 0){


                $this->RestaurantMenu->id = $menu_id;
                $this->RestaurantMenu->saveField('active',$active);
                $code = 200;
...
*/
    ...
    public function showTablesCount()
    {
        ...
        if ($this->request->isPost()) {
            ...
            $count['rider_request_count'] = $this->RiderRequest->getTotalRiderRequestCount();
